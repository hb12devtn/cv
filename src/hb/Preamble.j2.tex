...
\definecolor{secondaryColor}{RGB}{<<design.secondary_color.as_rgb_tuple()|join(", ")>>} % define secondary color
\definecolor{tertiaryColor}{RGB}{<<design.tertiary_color.as_rgb_tuple()|join(", ")>>} % define tertiary color
...
\newenvironment{projects}{
    \begin{itemize}[
        topsep=<<design.margins.projects_area.top>>,
        parsep=<<design.margins.projects_area.vertical_between_projects>>,
        partopsep=0pt,
        itemsep=0pt,
        leftmargin=<<design.margins.projects_area.left>> + 10pt
    ]
}{
    \end{itemize}
} % new environment for highlights
