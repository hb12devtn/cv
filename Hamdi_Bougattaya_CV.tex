    ...
    \section{Professional Experience}
        ...
        Feb 2025 – present
            ...
            \vspace{0.10 cm}
                ...
                \vspace{0.2cm}
                \textbf{Project \faAngleRight} \textit{Partners Mobile Application:}

                \begin{highlights}
                        \item Built cross-platform mobile application (iOS/Android) for Tahakom business partnership management
                        \item Implemented multi-environment deployment (Dev, Staging, Production) with secure authentication
                        \item Developed responsive UI with Arabic language support and custom theming
                \end{highlights}
                \faBuffer
