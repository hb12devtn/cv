...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+39-351-951-8866}{{\footnotesize\faPhone*}\hspace*{0.13cm}351 951 8866}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{}}{
            ...
            \textbf{University of Aix-Marseille}, Computer Science and Mathematics
        \end{threecolentry}
        ...
        \begin{threecolentry}{\textbf{}}{
            ...
            \textbf{University of Pisa}, Computer Science (1st year)
        \end{threecolentry}
