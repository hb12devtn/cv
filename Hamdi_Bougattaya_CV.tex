...
\begin{document}
    ...
    \begin{header}
        ...
        \textcolor{secondaryColor}{\textsubscript{\normalsize SENIOR KAFKA / JAVA FULL STACK ENGINEER}}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Pisa, Italy}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+216-52-240-967}{{\footnotesize\faPhone*}\hspace*{0.13cm}+216 52 240 967}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{+39 351 951 8866}{{\footnotesize\faWhatsapp}\hspace*{0.13cm}+39 351 951 8866}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \begin{onecolentry}
        ...
        \item \textbf{Red Hat Certified Cloud-native Developer \href{https://www.credly.com/badges/964e4256-5e0b-485d-805e-09487e880f67/linked_in_profile}{240-218-073}}
