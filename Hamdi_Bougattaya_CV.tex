...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in Feb 2026}\hspace{\widthof{Last updated in Feb 2026}}
    }}}%
  }%
}%
    ...
    \section{Professional Experience}
        ...
        Feb 2025 – present
            ...
            \vspace{0.10 cm}
                ...
                \textcolor{tertiaryColor}{\faAngleDoubleRight\hspace{0.1cm}\underline{\textit{Customer:} \textit{Tahakom}}}

                \vspace{0.2cm}
                \textbf{Project \faAngleRight} \textit{Safety \& Security Platform System:}

                \begin{highlights}
                        \item Developed a comprehensive multi-platform safety and security management system with mobile (Flutter) and web (Angular) interfaces
                        \item Built FastAPI backend with SQL Server database, Azure AD authentication, and Firebase push notifications
                        \item Implemented location-based tracking, inspection workflows, and task management features
                        \item Created PDF report generation and multi-language support (English/Arabic)
                \end{highlights}
                \faBuffer
                \textbf{ Technologies:} \textit{Flutter - Angular - FastAPI - Python - SQL Server - SQLAlchemy - Alembic - Azure AD (MSAL) - Firebase - AWS S3 - Docker - GitLab CI/CD}
                ...
                \vspace{0.2cm}
                \textbf{Project \faAngleRight} \textit{Vehicle Check Mobile Application:}

                \begin{highlights}
                        \item Built Flutter-based fleet management solution for vehicle check-in/check-out operations
                        \item Developed vehicle inventory management with search, filters, and photo-documented safety inspections
                        \item Implemented driver assignment tracking and comprehensive reporting features
                        \item Built offline-first architecture with automatic sync and Azure AD authentication
                        \item Delivered Arabic/English localization support
                \end{highlights}
                \faBuffer
                \textbf{ Technologies:} \textit{Flutter - Dart - Riverpod - GoRouter - Flutter AppAuth - Flutter Secure Storage}
                ...
                \vspace{0.2cm}
                \textbf{Project \faAngleRight} \textit{Multi-format Document Merger:}

                \begin{highlights}
                        \item Developed full-stack web application for converting and merging 12+ file formats into PDF documents
                        \item Built React frontend with drag-and-drop file upload and FastAPI backend with async processing
                        \item Integrated Gotenberg service for document conversion (LibreOffice + Chromium)
                \end{highlights}
                \faBuffer
                \textbf{ Technologies:} \textit{React - TypeScript - Vite - TailwindCSS - FastAPI - Python - pikepdf - Gotenberg - Docker - Docker Compose - Nginx}
