...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+216-52-240-967}{{\footnotesize\faPhone*}\hspace*{0.13cm}52 240 967}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+39 351 951 8866}{{\footnotesize\faWhatsapp}\hspace*{0.13cm}351 951 8866}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
